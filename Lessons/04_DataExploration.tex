...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#load the package without the message}
...
\CommentTok{#one dot is going in one level, tow dots is going out one level.}
...
\CommentTok{#in this case,you have to rename all of it, or else use [] to specify which column}
\KeywordTok{colnames}\NormalTok{(USGS.flow.data)[}\DecValTok{1}\NormalTok{] <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"agency_cd"}\NormalTok{)}
\KeywordTok{str}\NormalTok{(USGS.flow.data)}\CommentTok{#strucure of the data frame???}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(USGS.flow.data)}\CommentTok{#dimension:raws and column}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(USGS.flow.data)}\CommentTok{#give you number of column}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{USGS.flow.data[}\DecValTok{30000}\OperatorTok{:}\DecValTok{30005}\NormalTok{, }\KeywordTok{c}\NormalTok{(}\DecValTok{3}\NormalTok{, }\DecValTok{8}\NormalTok{, }\DecValTok{14}\NormalTok{)]}\CommentTok{#define raws,column}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{USGS.flow.data.complete <-}\StringTok{ }\KeywordTok{na.omit}\NormalTok{(USGS.flow.data)}\CommentTok{#take any data raw that has any NA.}
...
\NormalTok{today <-}\StringTok{ }\KeywordTok{Sys.Date}\NormalTok{()}\CommentTok{#base your computer dat}
\NormalTok{today}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{#tells R what is the format of the data}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# change the format of the data}
