...
## 4326 is the projection of any shp data tranfered from coordinates,
# if you have meters, you need to ask about the projection, then project
#setting is tell the R what it is
#projecting is change
# check class and CRS
...
#choose the NC then drop the attribute and get the shp
# check
# add your code here
...
#bound is the cookie cutter to cut the basin
...
nc_area# find the area of NC
nc_centroid <- st_centroid(nc_state_bounds_geom) 
nc_centroid# find the centroid of the NC
nc_gages_buffer_100m <- st_buffer(nc_gages, dist = 100)
nc_gages_buffer_100m# make a buffer around the stream gages in NC
