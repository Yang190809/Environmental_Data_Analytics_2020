...
> Answer: The ozone concentration from day to day are related to each other. For a any missing data, the concentration are close to the neighbor date. Spline interpolation might exaggeration the actual concentration.
...
> Answer: Because the Seasonal Mann-Kendall consider seasonality in our data.
